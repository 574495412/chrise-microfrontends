/*
 * @Descripttion:  读取文件夹并运行服务
 * @version: 
 * @Author: zhaoxiaodong
 * @Date: 2020-08-14 10:13:43
 * @LastEditors: zhaoxiaodong
 * @LastEditTime: 2020-09-01 13:41:28
 */
const fs = require('fs');
const path = require('path');
const util = require('util');
const sub_app_ath = path.resolve();
//读取含有design-center的项目
const sub_apps = fs.readdirSync(sub_app_ath).filter(i => /^master|design-center|subapp-/.test(i));
